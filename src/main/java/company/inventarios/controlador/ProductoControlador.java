package company.inventarios.controlador;


import company.inventarios.exception.RecursoNoEncontradoExcepcion;
import company.inventarios.modelo.Producto;

import company.inventarios.servico.ProductoServicio;
...
public class ProductoControlador {
    ...
    public List<Producto> obtenerPorductos(){
        ...
        logger.info("Porducto Obtenidos");
    ...
    public ResponseEntity<Producto> obtnerProductoPorId(
         @PathVariable int id){
    ...
    public ResponseEntity<Producto>acutalizarProducto(
            @PathVariable int id,
